...
(function () {
    ...
    URL = BAIDUEDITORURL;//"/njiandan/njiandan/modules/njiandan/webroot/js/ueditor/";//window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:(BAIDUEDITFILEURL=="" ? "" : "/" + BAIDUEDITFILEURL)                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,scrawlPath:(BAIDUEDITFILEURL=="" ? "" : "/" + BAIDUEDITFILEURL)                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"php/fileUp.php"               //附件上传提交地址
        ,filePath:(BAIDUEDITFILEURL=="" ? "" : "/" + BAIDUEDITFILEURL)                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        ,catchRemoteImageEnable:false               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"php/getRemoteImage.php"   //处理远程图片抓取的地址
        ,catcherPath:(BAIDUEDITFILEURL=="" ? "" : "/" + BAIDUEDITFILEURL)                  //图片修正地址，同imagePath
        ...
        ,snapscreenServerUrl: URL +"php/snapImgUp.php" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: (BAIDUEDITFILEURL=="" ? "" : "/" + BAIDUEDITFILEURL)
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:URL + "php/imageUp.php"             //word转存提交地址
        ,wordImagePath:(BAIDUEDITFILEURL=="" ? "" : "/" + BAIDUEDITFILEURL)                       //
        ...
        ,webAppKey:"K4IGTo6Y5ee24Zo9111bTL83"
